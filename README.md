...
|---|---|---|
| `.github/workflows/ci.yml` | каждый push и pull request | типы, 27 тестов, синтаксис и связность клиента — на Windows, Linux и macOS; затем пробная сборка исполняемого файла на каждой из них |
